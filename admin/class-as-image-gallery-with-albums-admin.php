 ...
 * @subpackage AS_Image_Gallery_With_Albums/admin
 */
 ...
 */
class AS_Image_Gallery_With_Albums_Admin {
     ...
     * @since    1.0.0
     */
    public function create_cpt_gallery() {

        /**
         * This function add a custom post tye - 'gallery'
         */
     ...
     * @since    1.0.0
     */
    public function create_taxo_gallery_cat() {

        /**
         * Create a new custom taxonomy 'gallery-cat'
         */

        $post_type = 'gallery';
        $all_taxonomy = array('Album');
